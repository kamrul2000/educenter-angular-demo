          ...
          <div class="row g-4">
            <div class="col-lg-4">
              <div class="d-flex align-items-center gap-3 mb-3">
                <img
                  src="assets/logo.svg"
                  alt="Star EduCenter Logo"
                  style="width:56px;height:56px;border-radius:12px;object-fit:contain;background:rgba(255,255,255,0.12);padding:3px;"
                />
                <div>
                  <h5 class="mb-0 text-white fw-bold">Star EduCenter</h5>
                  <small class="text-light opacity-75"
                    >Learn Smart, Gain Confidence</small
                  >
                </div>
              </div>
              <p class="text-light opacity-75 small">
                বাংলাদেশের ক্লাস ৬-১০ এর শিক্ষার্থীদের জন্য সর্বোত্তম ডিজিটাল
                শিক্ষা প্ল্যাটফর্ম। স্মার্টভাবে পড়ুন, আত্মবিশ্বাসী হন।
              </p>
              <div class="d-flex gap-3 mt-3">
                <a href="#" class="text-light opacity-75 fs-5 hover-link"
            ...
            <div class="col-lg-4">
              ...
              <div class="demo-creds small">
                <div
                  class="cred-item mb-2 p-2 rounded"
                  style="background:rgba(255,255,255,0.08)"
                >
                  <i class="bi bi-person-fill text-warning me-2"></i>
                  <strong class="text-white">Student:</strong>
                  <span class="text-light opacity-75 ms-1"
                    >student&#64;demo.com / demo123</span
                  >
                </div>
                <div
                  class="cred-item mb-2 p-2 rounded"
                ...
                >
                  ...
                  <span class="text-light opacity-75 ms-1"
                    >teacher&#64;demo.com / demo123</span
                  >
                </div>
                <div
                  class="cred-item p-2 rounded"
                  style="background:rgba(255,255,255,0.08)"
                >
                  <i class="bi bi-shield-fill text-danger me-2"></i>
                  <strong class="text-white">Admin:</strong>
                  <span class="text-light opacity-75 ms-1"
                    >admin&#64;demo.com / demo123</span
                  >
                </div>
              </div>
            </div>
      ...
      <div class="footer-bottom py-3 border-top border-secondary">
        ...
        >
          <p class="text-light opacity-50 small mb-0">
            © 2026 Star EduCenter. All rights reserved. &nbsp;|&nbsp; 🇧🇩
            &nbsp;|&nbsp;
            <span class="text-warning opacity-100 fw-semibold"
              >Designed & Built by Kamrul</span
            >
          </p>
          <div class="d-flex gap-3 mt-2 mt-md-0">
            <a href="#" class="text-light opacity-50 small text-decoration-none"
              >Privacy Policy</a
            >
            <a href="#" class="text-light opacity-50 small text-decoration-none"
              >Terms of Use</a
